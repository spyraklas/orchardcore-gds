...
namespace OrchardCore.GDS.Components.Workflows.Activities
{
    ...
    public class ValidateCharacterCountTask : TaskActivity
    {
        private readonly IHttpContextAccessor _httpContextAccessor;
        private readonly IUpdateModelAccessor _updateModelAccessor;
        private readonly IStringLocalizer S;

        public ValidateCharacterCountTask(
            IHttpContextAccessor httpContextAccessor,
            IUpdateModelAccessor updateModelAccessor,
            IStringLocalizer<ValidateCharacterCountTask> localizer
        )
        {
        ...
        public override string Name => nameof(ValidateCharacterCountTask);

        public override LocalizedString DisplayText => S["Validate Form Field Character Count Task"];
